			...
			<div className="container mx-auto px-4 py-8 lg:py-12">
				...
				<div className="mb-8 lg:mb-10">
					<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
						<div>
							<h1 className="flex items-center gap-4 text-2xl font-bold text-foreground lg:text-3xl">
						...
						{orders.length > 0 && (
							<Link
								href="/produtos"
								className="inline-flex items-center justify-center rounded-xl bg-brand-600 px-6 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-700"
							>
								Novo Pedido
							</Link>
						)}
					...
					<Card className="border border-divider bg-background shadow-sm">
						<CardBody className="flex min-h-[400px] flex-col items-center justify-center p-8 text-center">
							<div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-default-100">
								<ShoppingBagIcon className="h-10 w-10 text-default-400" />
							</div>
							...
							<Link
								href="/produtos"
								className="rounded-xl bg-brand-600 px-6 py-4 font-semibold text-white transition hover:bg-brand-700"
							>
								Ver Produtos
							</Link>
						</CardBody>
